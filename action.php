...
if(isset($_POST['action']) && isset($_POST['action']) == 'order'){
    ...
    $stmt->execute();
    $to='majdirroshi17@gmail.com'; 
		$subject='Form Submission';
		$message="Emri: ".$name."\n"."Numri i telefonit: ".$numri."\n"."Adresa: ".$adresa."\n"."Produktet: ".$produktet."\n"."Cmimi: ".$grand_total." leke";
		$headers="From: ".$email;
       $data='';
    $data .= '<div class="text-center">
    <h1 class="display-4 mt-2"><b>Faleminderit!</b></h1>
    <h2 class="p-2" style="background-color:#171717; color:#F7EBEB;">Porosia juaj u krye me sukses!</h2>
    <h4 class="rounded p-2" style="background-color:#F7EBEB;">Produktet e porositura: '.$produktet.'</h4>
    <h4>Emri: '.$name.'</h4>
    <h4>Emaili: '.$email.'</h4>
    ...
    <h4>Pagesa totale: '.number_format($grand_total).' leke</h4>
		...
		if(mail($to, $subject, $message, $headers)){
			...
			echo "Dicka nuk shko sic duhet, ju lutem provoni perseri!";
		}
}
