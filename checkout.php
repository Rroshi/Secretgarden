     ...
     <div class="container">
      <div class="row justify-content-center">
          ...
          <form action="" method="post" id="placeOrder">
              ...
              <div class="form-group">
                  <input type="text" name="adresa" class="form-control" placeholder="Fusni adresen tuaj" required>
              </div>
              
               <div class="form-group">
                  <a href="action.php?clear=all"><input type="submit" name="submit" class="btn btn-block" style="background-color:#171717; color:#F7EBEB;" value="Perfundoni porosine"required></a>
               </div>
